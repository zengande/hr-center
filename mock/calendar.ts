...
export default {
    'GET /api/calendar': (req: any, res: any) => {
        ...
        const result = new Array<{ date: string, count: Number, list?: Array<{ name: string, title: string, time: string }> }>();
        ...
        for (var i = 0; i < count; i++) {
            ...
            const list = new Array<{ name: string, title: string, time: string }>();
